...
| `uiautoma.web.WebBrowser.wait_appear()` | `VERIFIED`（29/29 + 1 边界；2026-09-15；连续 3 次全绿；调度式与靶场自计时页两条转变来源均已实测） | `web/test_web_browser_wait_appear.py` | `web/evidence/wait_appear.md` |
