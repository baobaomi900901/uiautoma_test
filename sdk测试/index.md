...
| `uiautoma.web.WebElement.select()` | `VERIFIED`（2026-09-24：13/14 PASS + 1 KNOWN，连续 3 次退出码 0；标准 `<select>`） | [`web/test_web_element_select_iframe_shadow_form.py`](web/test_web_element_select_iframe_shadow_form.py) | [`web/evidence/select.md`](web/evidence/select.md) | [`sdk/docs/web/select.md`](../../sdk/docs/web/select.md) |
