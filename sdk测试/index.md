...
| `uiautoma.web.WebBrowser.wait_appear()` | `VERIFIED`（29/29 + 1 边界；2026-09-15；连续 3 次全绿；调度式转变已验证，自计时页待靶场部署） | `web/test_web_browser_wait_appear.py` | `web/evidence/wait_appear.md` |
